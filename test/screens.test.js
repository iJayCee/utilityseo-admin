...
const PROPS = {
  ...
  PromosSection:          { createPromo: noop, deletePromo: noop, email: '', expandedPromo: null, loadCodeRevenue: noop, loadPromoSignups: noop, loading: false, loadingPromos: false, mainAppUrl: 'https://app.utilityseo.com', promoForm: { code: '', description: '', trial_plan: 'entrepreneur', trial_days: '30', max_uses: '', expires_at: '', partner_name: '', partner_email: '', partner_share_pct: '50', partner_share_months: '6', partner_notes: '' }, promoFormError: '', promoSignups: {}, promos: [], savingPromo: false, setPromoForm: noop, stats: STATS, togglePromoActive: noop, users: [] },
